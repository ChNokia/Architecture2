...
dict_article = {'title_article': 'Финал Лиги Чемпионов 2015/16 пройдет в Милане',
...
def main():
	data_file = None
	template_loader = TemplateEngine(searchpath = '/home/ubuntu/Desktop/devclub/Architecture2/templates')
	route_strings = []
